...
!(function(n, e) {
	'object' == typeof exports && 'undefined' != typeof module
		...
		: 'function' == typeof define && define.amd ? define(['jquery'], e) : (n.metisMenu = e(n.jQuery));
})(this, function(n) {
	'use strict';
								...
								r.preventDefault && n.preventDefault(),
									'true' !== e.attr('aria-disabled') &&
										(i.hasClass(r.activeClass)
											? (e.attr('aria-expanded', !1), a.hide(s))
											: (a.show(s),
												e.attr('aria-expanded', !0),
												r.toggle && t.attr('aria-expanded', !1)),
					...
					if (!this.transitioning && o(n).hasClass(this.config.collapseInClass)) {
						...
						if ((i.trigger(t), !t.isDefaultPrevented())) {
							...
							var s = function() {
								e.config &&
									e.element &&
									(e.transitioning && e.config.onTransitionEnd && e.config.onTransitionEnd(),
									e.setTransitioning(!1),
									i.trigger(c.HIDDEN),
									i.removeClass(e.config.collapsingClass).addClass(e.config.collapseClass));
							};
