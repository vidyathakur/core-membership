...
const routes: Routes = [
  ...
  { path: 'membership/:client_id/:merchant_id', loadChildren: './membership/membership.module#MembershipModule',
  ...
  data: { showHeader: false,showSidebar: false},
  canActivate:[AuthGuardService] },
  { path: 'build-membership', 
  loadChildren: './build-membership/build-membership.module#BuildMembershipModule',
  data: { showHeader: false,showSidebar: false},
  canActivate:[AuthGuardService] },
  { path: 'pos', loadChildren: './pos/pos.module#PosModule',canActivate:[AuthGuardService] },
  { path: 'clientformembership', loadChildren: './clientformembership/clientformembership.module#ClientformembershipModule',
  // data: { showHeader: false,showSidebar: false},
  canActivate:[AuthGuardService] },
